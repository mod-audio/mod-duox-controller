...
// SERIAL1
#define SERIAL1
#define SERIAL1_BAUD_RATE       1500000
#define SERIAL1_PRIORITY        1
#define SERIAL1_RX_PORT         2
#define SERIAL1_RX_PIN          1
#define SERIAL1_RX_FUNC         2
#define SERIAL1_RX_BUFF_SIZE    32
#define SERIAL1_TX_PORT         2
#define SERIAL1_TX_PIN          0
#define SERIAL1_TX_FUNC         2
...
///4 actuator leds `              
#define LED0_PINS           {1, 28, 1, 29, 0, 0}
#define LED1_PINS           {0, 10, 0, 11, 2, 13} 
#define LED2_PINS           {2, 6, 2, 5, 2, 4}
#define LED3_PINS           {2, 2, 0, 9, 0, 8}
 //3 "system" leds
#define LED4_PINS           {0, 28, 0, 27, 3, 26}
#define LED5_PINS           {0, 29, 0, 30, 1, 18}
#define LED6_PINS           {1, 25, 1, 26, 1, 27}
...
#define GLCD0_CONFIG    { GLCD_COMMON_CONFIG, \
                          .cs_port = 0, .cs_pin = 16, \
                          .rst_port = 0, .rst_pin = 17, \
                          .backlight_port = 0, .backlight_pin = 20,\
                          .PM_VALUE = 8 },

#define GLCD1_CONFIG    { GLCD_COMMON_CONFIG, \
                          .cs_port = 2, .cs_pin = 11, \
                          .rst_port = 0, .rst_pin = 22, \
                          .backlight_port = 2, .backlight_pin = 12, \
                          .PM_VALUE = 28 },
...
//POT0, POT1, POT2, POT3, POT4, POT5, POT6, POT7,
...
#define FOOTSWITCH0_PINS    {0, 1} // BTN4
#define FOOTSWITCH1_PINS    {2, 7} // BTN5
#define FOOTSWITCH2_PINS    {2, 3} // BTN6
#define FOOTSWITCH3_PINS    {0, 7} // BTN7
#define FOOTSWITCH4_PINS    {3, 25} //BTN1, snapshot
#define FOOTSWITCH5_PINS    {1, 19} //BTN2, pages
#define FOOTSWITCH6_PINS    {1, 22} //BTN3, snapshot
...
#define ENCODER0_PINS       {1, 15, 1, 17, 1, 16}
#define ENCODER1_PINS       {0, 4, 0, 6, 0, 5}
...
#define POT3_PINS        {0, 3,  2, 5} //pot 3
#define POT4_PINS        {0, 25, 1, 2} //pot 4
#define POT5_PINS        {0, 26, 1, 6} //pot 5
#define POT6_PINS        {1, 31, 3, 3} //pot 6
#define POT7_PINS        {0, 2,  2, 7} //pot 7

#define SHUTDOWN_BUTTON_PORT    1
#define SHUTDOWN_BUTTON_PIN     14
...
#define WEBGUI_SERIAL               1

// define how many bytes will be allocated to rx/tx buffers
#define WEBGUI_COMM_RX_BUFF_SIZE    3096
...
#define GAIN_STAGE_ID 		(21*10)
#define IN1_STAGE_ID	GAIN_STAGE_ID+2
#define IN2_STAGE_ID	GAIN_STAGE_ID+7

#define SYSTEM_MENU     \
    {"SETTINGS",                        MENU_LIST,      ROOT_ID,            -1,             NULL                       , 0},  \
    {"BANKS",                           MENU_OK,        BANKS_ID,           ROOT_ID,        NULL            , 0},  \
    ...
    {"GAIN STAGES (LEGACY DUO)",        MENU_LIST,      GAIN_STAGE_ID,      DEVICE_ID,      NULL       				   , 0},  \
    {"< BACK TO SYSTEM",                MENU_RETURN,    GAIN_STAGE_ID+1,    GAIN_STAGE_ID,  NULL          	           , 0},  \
    {"STAGE IN 1",                      MENU_SELECT,      IN1_STAGE_ID,       GAIN_STAGE_ID,  system_stage_cb                       , 0},  \
    {"< Back to Gains",                 MENU_RETURN,    IN1_STAGE_ID+1,     IN1_STAGE_ID,   NULL                       , 0},  \
    ...
    {"STAGE IN 2",                      MENU_SELECT,      IN2_STAGE_ID,       GAIN_STAGE_ID,  system_stage_cb                       , 0},  \
    {"< Back to Gains",                 MENU_RETURN,    IN2_STAGE_ID+1,     IN2_STAGE_ID,   NULL                       , 0},  \
