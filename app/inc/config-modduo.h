...
///4 actuator leds `              
#define LED0_PINS           {1, 29, 1, 28, 0, 0}
#define LED1_PINS           {0, 11, 0, 10, 2, 13} 
#define LED2_PINS           {2, 5, 2, 6, 2, 4}
#define LED3_PINS           {0, 9, 2, 2, 0, 8}
 //3 "system" leds
#define LED4_PINS           {0, 27, 0, 28, 3, 26}
#define LED5_PINS           {0, 30, 0, 29, 1, 18}
#define LED6_PINS           {1, 26, 1, 25, 1, 27}
...
#define SL_IN_GET_CMD            "get_in_chan_link 0" 
// set stereo link for the inputs 
#define SL_OUT_SET_CMD           "set_out_chan_link 0 %i"                       
// get the current stereo link value for the inputs
#define SL_OUT_GET_CMD           "get_out_chan_link 0"
...
#define MASTER_VOL_SET_LINK_CMD     "get_master_volume_channel"
//get master volume link channel
#define MASTER_VOL_GET_LINK_CMD     "set_master_volume_channel %i"
